...
const DevStory = () => {
  return (
    <div>
      ...
      <h1 className="text-4xl font-bold text-blue-700">Developer Story</h1>
      <p className="mt-4 text-lg text-gray-600">
        This page highlights our development process and challenges we faced along the way from idea concept to full production
      </p>
